...
import com.nicolasfabucci.ecommerceFabucci.entity.schemas.responses.Response;
import com.nicolasfabucci.ecommerceFabucci.handler.exceptions.ApiRestException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Response> indexOutOfBoundsException(IndexOutOfBoundsException e) {
        final Response<String> result = new Response(Instant.now(),
                "[ProductoController] - IndexOutOfBoundsException- Not Found. " + e.getMessage(), 404, "Error");
